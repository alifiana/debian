...
echo 'echo -e "Script mod by AlfianGhz"' >> .bashrc
...
echo "<pre>Setup by AlfianGhz</pre>" > /home/vps/public_html/index.html
...
echo "Modified by AlfianGhz"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
